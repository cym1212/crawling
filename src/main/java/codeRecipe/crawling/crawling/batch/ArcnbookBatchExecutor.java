...
public class ArcnbookBatchExecutor {
    private final ArcnbookPythonScriptExecutor executor; // Python 실행 클래스

    public ArcnbookBatchExecutor(ArcnbookPythonScriptExecutor executor) {
