...
public class HyggebookBatchExecutor {
    private final HyggebookPythonScriptExecutor executor; // Python 실행 클래스

    public HyggebookBatchExecutor(HyggebookPythonScriptExecutor executor) {
